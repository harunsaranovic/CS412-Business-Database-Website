...
session_start();
$id = $_GET['id'];
$sqlquery = "SELECT * FROM companies WHERE id=" . $id;
    ...
    ?>
      <div class="company-box">
        ...
        <div class="company-box-info">
          ...
          <div class="info-box">
            <span class="info-placeholder">Address:</span>
            <br>
            <span><?php echo $company['address']; ?></span>
          </div>
          <div class="info-box">
            <span class="info-placeholder">Phone:</span>
            <br>
            <span><?php echo $company['phone']; ?></span>
          </div>
          <div class="info-box">
            <span class="info-placeholder">Email:</span>
            <br>
            <span><?php echo $company['mail']; ?></span>
          </div>
          <div class="info-box">
            <span class="info-placeholder">Website:</span>
            <br>
            <span><?php echo $company['website']; ?></span>
          </div>
          <div class="info-box">
            <span class="info-placeholder">Contact person:</span>
            <br>
            <span><?php echo $company['person']; ?></span>
          </div>
        </div>
      </div>
    <?php
